...
public class BasicWebBrowser extends Frame implements ActionListener, WindowListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        DataOutputStream os = null;   //output stream (send data!)
        DataInputStream is = null;    //input stream (get data back!)
        ...
        if (httpSocket != null && os != null && is != null) {
           try
           {
               ...
               returnPage.append(theRequest);
                  os.writeBytes(theRequest); //send the request to the web server
